...
#set enum(spacing: 21.465pt)
+ How does the social planner get prices such that q\_s = q\_d = q\_SOC?

+ If the price is set at buyers WTP, excess.

+ If the price is set at sellers WTS, shortage.

+ A tax or subsidy equal to the externality sets q\_s = q\_d = q\_SOC.
