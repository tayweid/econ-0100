...
- On the first bar only, show Cost = $2 and PS = $3 beside their areas, rounded to whole dollars while retaining the midpoint geometry. PS updates with price ($1 at $3; $2 at $4; $3 at $5), and both amounts hide with their labels below cost. All later bars retain word-only labels.
