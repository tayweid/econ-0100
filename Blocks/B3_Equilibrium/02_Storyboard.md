...
| `5.d.s.question`, `5.d.d.question`, `5.d` | $6 above equilibrium | Same colored, term-by-term arithmetic: aggregate Qs=80, Qd=30. Discrete Qs=10, Qd=3. Show seven orange boxes beside the producing sellers who do not yet have a buyer. Place them 0.40 units right and 0.22 toward the camera from each seller, outside the bars so none are hidden. Keep those boxes through terminology and deliberation. |
...
- September 21 unsold-production boxes: kept the seven $6 boxes through
  Gary's comparison and transferred the unmatched status from Molly to Andrew
  on acceptance. Audited every seeded adjustment round: one box per producing,
  unmatched seller, with no box beside a reserved unit. At settlement the four
  remaining units belong to MC-$5/$6 sellers; a new `5.g.production` hold shows
  the $4 price before those sellers stop producing and their boxes disappear.
  Boxes sit outside the marginal bars for visibility. The final $4.25 refusal
  also creates an unsold unit until the $4 reservation is restored. Live-reviewed Gary's acceptance, the four-box withdrawal pause and cleared equilibrium, and the
  refusal close-up. Syntax and whitespace checks pass; no exports were needed.
