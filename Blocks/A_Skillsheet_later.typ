// Exported from Plass
// A_Skillsheet_later: Skillsheet A with the four "explain" bullets redrafted in do-form.
// Draft by Claude at Taylor's request (2026-09-07), for Taylor to accept, edit, or reject.
// Each redraft is marked inline with the original kept above it as a comment. Nothing else changed.
...
// [Claude draft, 2026-09-07] Do-form twin of the explain bullet. Original:
...
// Note: once in do-form this overlaps the next bullet; the two could merge into one.
- Find the opportunity cost of a choice as the value of the next best alternative given up, including choices where no money changes hands.
...
- Identify the comparative advantage in each good when one producer holds the absolute advantage in both, and recognize that each producer holds exactly one comparative advantage.
...
- Find terms of trade that make both parties better off, and identify the full range of exchange rates that work: any rate between the two producers' opportunity costs.
// [Claude draft, 2026-09-07] Do-form twin of the explain bullet. Original:
...
- Show, with a graph or with numbers, whether a proposed trade leaves both parties beyond their autarky production points, and identify which side rejects a proposed trade and why.
