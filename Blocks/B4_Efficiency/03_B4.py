...
class B4(ThreeDScene):
    ...
    def construct(self):
        ...
        stop_reason = fixed(Tex('We stop when no one wants to bid.', color=DEFINITION)
        ...
        high_trade_question = fixed(Tex('Who trades?', color=DEFINITION).scale(DEFINITION_SCALE)
                                    .set_x(0).to_edge(DOWN, buff=DEFINITION_BOTTOM))
        self.remove(head)
        self.play(FadeIn(high_head), FadeIn(high_trade_question))
        head = high_head
        self.pause('1.g')
        ...
        card_text = fixed(VGroup(
            ...
            Tex('Quantity demanded: 6; quantity supplied: 14.', color=INK).scale(0.82),
        ...
        card_text = fixed(VGroup(
            ...
            Tex('Quantity demanded: 14; quantity supplied: 6.', color=INK).scale(0.82),
            Tex('a) How many pasties are exchanged?', color=INK).scale(0.88),
