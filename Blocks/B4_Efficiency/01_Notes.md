...
*~Do something like hearts floating up.*
...
~~So we can start by finding the CS for the buyer with the highest willingness to pay. Then we move out across the ...~~
...
2. Above the price buyers are paying
...
I would have been willing to charge $2$ less dollars, but instead, I can keep those extra dollars.
...
*~Highlight consumer surplus and producer surplus.*
...
~~Let me offer some level of caution here. This model is very specific. We'll introduce some variations to this model in the coming weeks. This model looks only at private goods with no externalities.~~
