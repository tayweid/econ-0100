...
The Ministry of Magic decided to institute a price ceiling of #mi(`7`) galleons to allow many more to afford the treat. Use a graph to evaluate the welfare effects this policy had on the market: label and calculate CS, PS, DWL, and which direction incentives push prices due to this policy.
...
The Ministry of Magic decided that the market price wasn’t sufficiently high enough for sellers, and decided to institute a price floor of #mi(`11`) galleons to raise the price. Use a graph to evaluate the welfare effects this policy had on the market.
