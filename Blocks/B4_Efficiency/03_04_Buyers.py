...
class B4Buyers(ThreeDScene):
    ...
    def construct(self):
        ...
        self.add(floor, rim)
        # The same profile becomes the demand curve while people fold into rows.
        ...
        gary_focus = Circle(radius=0.22, color=FOCUS, stroke_width=3).move_to(buyer_positions[29])
