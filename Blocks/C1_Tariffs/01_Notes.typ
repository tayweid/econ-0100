...
_A tariff is just a tax on imports._

This video picks up with international trade but tells the story of the political backlash to opening the border.

Most of the writing is in B7. But it might be best to do all this in one video, in which case international trade would be in C1.
